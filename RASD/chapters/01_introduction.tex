...
\begin{itemize}
    ...
    \item \textbf{[G3]}: A registered user aims to receive statistics about its past trips, including average speed, trip time and meteorological conditions (at recording time)
    \item \textbf{[G4]}: A registered user wants to share information about a bike trip it has recorded, including their status and the presence of obstacles, making this information available to the community (all users)
